...
//#define LDR 4
#define ldr_channel ADC2_CHANNEL_0
//adc2_channel 0

gpio_pad_select_gpio(LDR);
gpio_set_direction(LDR, GPIO_MODE_INPUT);
gpio_pulldown_en(LDR);
gpio_pullup_dis(LDR);

// Configura o conversor AD
adc1_config_width(ADC_WIDTH_BIT_10);
adc1_config_channel_atten(ldr_channel, ADC_ATTEN_MAX);
...
static void mqtt_app_start(void)
{
    ...
    esp_mqtt_client_register_event(client, ESP_EVENT_ANY_ID, mqtt_event_handler, temperatura );
...
void dht_test(void *pvParameters)
{
    ...
    while (1)
    {
        ...
        int ldr = adc1_get_raw(ldr_channel);
