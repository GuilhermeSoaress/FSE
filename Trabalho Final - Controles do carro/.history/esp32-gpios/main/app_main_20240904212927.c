...
void configuraPinos(){
    ...
    gpio_set_intr_type(botaoBiometria, GPIO_INTR_ANYEDGE);
  ...
  while(true)
  {
    ...
    //   {
        ...
        case botaoPorta:
            ...
            portaStatus = estado; 
            snprintf(attributes, sizeof(attributes), "{\"porta\": %d, \"\luzInterna\": %d}", portaStatus, luzInternaStatus);
