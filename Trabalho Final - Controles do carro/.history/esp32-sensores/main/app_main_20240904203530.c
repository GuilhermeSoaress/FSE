...
void trataInterrupcaoBotao(void *params)
{
  ...
  while(true)
  {
    ...
    //   {
        ...
        case botaoFarol:
            farolStatus = estado; 
            snprintf(attributes, sizeof(attributes), "{\"farol\": %d, \"botaoVidros\": %d, \"botaoTravar\": %d, \"travadoStatus\": %d}", farolStatus,botaoVidrosStr, botaoTravarStatus, travadoStatus);
        ...
        case botaoVidros:
            ...
            sprintf(botaoVidrosStr, "%d", estado);
