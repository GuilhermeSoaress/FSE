...
char method[50], params[];



void separaParametros(const char *json_str, char *method, char *params) {
...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    switch (event_id) {
        ...
        case MQTT_EVENT_DATA:
           ...
           strcpy(farolStatus, params);
            separaParametros(event->data, method, params);
            printf("Method: %s\n", method);
            printf("Params: %s\n", params);
...
void dht_test(void *pvParameters)
{
    ...
    while (1)
    {
        ...
        sprintf(attributes, "{\"farol\": %s}", farolStatus);
