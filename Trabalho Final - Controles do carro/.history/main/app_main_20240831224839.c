...
void dht_test(void *pvParameters)
{
    ...
    while (1)
    {
        ...
        sprintf(attributes, "{\"temperatura\": %.2f, \"umidade\": %.2f, \"luminosidade\" : %s, \"farois\" : %s}", temperature, humidity, luminosidade);
...
void app_main(void)
{
   ...
   //mqtt_envia_mensagem("v1/devices/me/attributes/request/$request_id", );
}
